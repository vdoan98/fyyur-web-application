...
from wtforms.validators import DataRequired, AnyOf, URL, Optional, Regexp, Length, ValidationError
import re
import phonenumbers
...
class VenueForm(Form):
    ...
    phone = StringField(
        'phone', validators=[Optional(), isValidPhone, isValidPhoneState, Length(min=10, max=18)]
    )
